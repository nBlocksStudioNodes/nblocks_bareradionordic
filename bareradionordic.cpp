#include "bareradionordic.h"

nBlock_BareRadioNordic::nBlock_BareRadioNordic: _config, _radio (        
...
void nBlock_BareRadioNordic::triggerInput(nBlocks_Message message) {
